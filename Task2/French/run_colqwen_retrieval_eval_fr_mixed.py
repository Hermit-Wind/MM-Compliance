# run_colqwen_retrieval_eval_fr_mixed.py
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="ColQwen2.5 Retrieval Evaluation - French (MIXED)")
    ...
    print("\n" + "=" * 90)
    print(" " * 18 + "ColQwen2.5 Retrieval Evaluation System - French (MIXED)")
    print("=" * 90)
