...
Wrap your observations within <observe></observe> tags."""
    ...
    image_step2_instruction: str = (
        "Step 2: Record Evidences from Images\n"
        "After reviewing all images, record the evidence you find for each image "
        "within <evidence></evidence> tags.\n"
        "If you are certain that an image contains no relevant information, record "
        "it as: [i]: no relevant information(where i denotes the index of the image).\n"
        "If an image contains relevant evidence, record it as: [j]: "
        "[the evidence you find for the question](where j is the index of the image)."
    )
...
Include your step-by-step reasoning within <think></think> tags."""
    ...
    image_step4_instruction: str = (
        ...
        "Avoid adding unnecessary contents in your final answer, like if the "
        "question is a yes/no question, simply answer \"yes\" or \"no\".\n"
        "Additionally, if the task is a multi-class classification task, you must "
        "make sure your answer uses one of all possible options.For example, for a "
        "3-class problem with options yes / yes but not complete / no, you should "
        "answer exactly one of: \"yes\", \"yes but not complete\", or \"no\"."
    )
...
Include your step-by-step reasoning within <think></think> tags."""
    ...
    text_step4_instruction: str = (
        "Step 4: Answer the Question\n"
        "Provide your final answer based only on the evidences you found in the "
        "OCR text.\n"
        "Wrap your answer within <answer></answer> tags.\n"
        "Avoid adding unnecessary contents in your final answer, like if the "
        "question is a yes/no question, simply answer \"yes\" or \"no\".\n"
    ...
    image_prompt: str = (
        "You are an AI Visual QA assistant. I will provide you with a "
        "question and several images. Please follow the four steps below:\\n"
        f"{image_step1_instruction}\\n\\n"
        f"{image_step2_instruction}\\n\\n"
        f"{image_step3_instruction}\\n\\n"
        f"{image_step4_instruction}\\n\\n"
        "Formatting Requirements:\\n"
        "Use the exact tags <observe>, <evidence>, <think>, and <answer> "
    ...
    text_prompt: str = (
        "You are an AI Visual QA assistant. I will provide you with a "
        "question and several images. Please follow the four steps below:\\n"
        f"{text_step1_instruction}\\n\\n"
        f"{text_step2_instruction}\\n\\n"
        f"{text_step3_instruction}\\n\\n"
        f"{text_step4_instruction}\\n\\n"
        "Formatting Requirements:\\n"
        "Use the exact tags <observe>, <evidence>, <think>, and <answer> "
        "for structured output."
    )
    ...
    fewshots = (
        "First, there will be some examples for you to understand the task, "
        "you can answer the question based on given examples\\n"
        "Examples:\\n"
        f"{few_shot}"
    )
...
<EOF>"""
    ...
    text_query_body: str = (
        "Below, after the 'Topic' and 'Metric' is the topic of information, "
        "also, metric that may occured in document.\n"
        "You should judge whether the mentioned topic, metric and "
        "corresponding value occured in the document provided or not.\n"
        "There is no image information, you should answer the question "
        "based only on the ocr text provided above.\n"
