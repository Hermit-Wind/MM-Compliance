# build_queries_regcom_fr_mixed.py
"""
Build query files from RegCom_Trainset_FR.json (mixed complete: true + false)
...
IN_JSON = BASE_DIR / "RegCom_Trainset_FR.json"  # 直接在当前目录
OUT_DIR = BASE_DIR / "queries_regcom_mixed"      # 输出也在当前目录
...
def main():
    ...
    for row in data:
        ...
        # 保留所有样本（complete == True / False 均包含）
