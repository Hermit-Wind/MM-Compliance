# run_colqwen_retrieval_eval_chinese.py
...
QUERIES_DIR = BASE_DIR / "queries_chinese_by_industry"
OUT_BASE_DIR = BASE_DIR / "results_colqwen_eval_chinese"
...
def print_evaluation_results(results, industry):
    ...
    print("\n" + "=" * 90)
    print(f" {industry.upper()} - RETRIEVAL EVALUATION RESULTS".center(90))
    print("=" * 90)
...
def load_pages_and_queries(industry):
    ...
    query_file = QUERIES_DIR / f"queries_chinese_{industry}.json"
...
def encode_images_with_cache(images, processor, model):
    ...
    cache_file = CACHE_DIR / "cache_colqwen_image_emb_chinese.pt"
...
def process_industry(industry, model, processor, emb_docs, doc_names):
    ...
    print("\n" + "=" * 90)
    print(f"PROCESSING INDUSTRY: {industry.upper()}".center(90))
    print("=" * 90)
...
def main():
    parser = argparse.ArgumentParser(
        description="ColQwen2.5 Retrieval Evaluation by Industry (Chinese)",
    ...
    print("\n" + "=" * 90)
    print("ColQwen2.5 Retrieval Evaluation System (Chinese - By Industry)".center(90))
    print("=" * 90)
    ...
    query_files = sorted(QUERIES_DIR.glob("queries_chinese_*.json"))
    available_industries = [f.stem.replace("queries_chinese_", "") for f in query_files]
    ...
    # Print final summary
    print("\n" + "=" * 90)
    print("FINAL SUMMARY - ALL INDUSTRIES".center(90))
    print("=" * 90)
